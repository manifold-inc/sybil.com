export default function Page() {
  return (
    <main className="prose-headings:font-blinker prose-p:text-mf-edge-500 prose-a:text-mf-edge-500 prose-strong:text-mf-edge-500 prose-code:text-mf-edge-500 prose-pre:bg-transparent prose-pre:text-mf-edge-500 prose-ol:marker:text-mf-edge-500 prose-ul:marker:text-mf-edge-500 prose-li:text-mf-edge-500 prose prose-sm prose-invert text-mf-milk-300 md:prose-base lg:prose-lg prose-headings:font-semibold prose-h1:font-semibold prose-h1:text-mf-milk-500 prose-h3:text-mf-milk-300 prose-pre:w-full prose-pre:max-w-[calc(100vw-2rem)] prose-pre:overflow-x-auto prose-pre:whitespace-pre-wrap prose-pre:break-words prose-pre:border prose-pre:border-mf-ash-300 prose-pre:text-xs md:prose-pre:text-sm lg:prose-pre:text-base mx-auto w-full max-w-lg px-4 py-40 md:max-w-2xl lg:max-w-4xl [&_a]:break-all">
