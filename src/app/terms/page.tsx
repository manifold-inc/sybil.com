export default function Page() {
  return (
    <main className="mx-auto prose prose-sm prose-invert w-full max-w-lg text-mf-milk-300 md:prose-base lg:prose-lg prose-headings:font-blinker prose-headings:font-semibold prose-h1:font-semibold prose-h1:text-mf-milk-500 prose-h3:text-mf-milk-300 prose-p:text-mf-edge-500 prose-a:text-mf-edge-500 prose-strong:text-mf-edge-500 prose-code:text-mf-edge-500 prose-pre:w-full prose-pre:max-w-[calc(100vw-2rem)] prose-pre:overflow-x-auto prose-pre:whitespace-pre-wrap prose-pre:break-words prose-pre:border prose-pre:border-mf-ash-300 prose-pre:bg-transparent prose-pre:text-xs prose-pre:text-mf-edge-500 prose-ol:marker:text-mf-edge-500 prose-ul:marker:text-mf-edge-500 prose-li:text-mf-edge-500 md:max-w-2xl md:prose-pre:text-sm lg:max-w-4xl lg:prose-pre:text-base [&_a]:break-all px-4 py-40">
      ...
      <p>
        ...
        Service&quot;) carefully before using the www.sybil.com website (the
        &quot;Service&quot;) operated by Manifold (&quot;us&quot;,
      ...
      <p>
        ...
        the Service. You agree not to share, transfer, or sell your account. You
        are responsible for all activities on your account. You agree not to use
        the Service in any way that causes, or may cause, damage to the Service
        or impairment of the availability or accessibility of the Service. You
        agree not to use the Service for unlawful, illegal, fraudulent or
        harmful activities, including but not limited to hate, harassment,
        violence, political manipulation, spam, or malware. You agree not to
        conduct any systematic or automated data collection activities
        (including scraping, data mining, data extraction or data harvesting) on
        or in relation to the Service. Prohibited data collection includes, but
        is not limited to, using the Service as input into other services,
        websites, or databases. You agree not to republish any content generated
        by the Service without clearly citing the Service as well as the context
      ...
      <p>
        ...
        operating, promoting, and improving our Service, and to develop new
        ones. Make sure you have the necessary rights to grant us this license
        for any content that you submit to our Services. You understand that all
        information, data, text, software, music, sound, photographs, graphics,
        video, messages, tags, or other materials (&quot;Content&quot;), whether
        ...
        not Manifold, are entirely responsible for all Content that you upload,
        post, email, transmit or otherwise make available via the Service.
        Manifold does not control the Content posted via the Service and, as
        ...
        circumstances will Manifold be liable in any way for any Content,
        ...
        Service. You agree that you must evaluate, and bear all risks associated
        ...
        or submitted to the Service. You acknowledge and agree that Manifold may
      ...
      <p>
        ...
        the same. As a user of the Service, you are granted access for your own
        personal, non-commercial use only. Any attempts to reverse engineer,
        copy, reproduce, or otherwise steal intellectual property from the
        Service will not be tolerated and may result in legal action. Manifold
        takes all allegations of copyright infringement seriously and will
        respond promptly to any notices that comply with applicable laws and are
        properly provided to us. If you believe that your work has been used in
      ...
      <p>
        ...
        performance. Manifold, its subsidiaries, affiliates, and its licensors
      ...
      <p>
        ...
        of a) your use and access of the Service, by you or any person using
      ...
      <p>
        ...
        &quot;Last updated&quot; date above. By continuing to access or use our
